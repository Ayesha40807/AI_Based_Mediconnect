...
def patient_detail(request):
    ...
    return render(request, 'patient_details.html', {'patient': patient, 'visits': visits})
...
def medication_details(request):
    if request.user.is_authenticated and request.user.user_type == 'patient':
        ...
        for visit in visits:
            medicine_names = visit.medicines.all()
            medicine_detail = {
                'visit_date': visit.visit_date,
                'medicine_names': [medicine.medicine_name for medicine in medicine_names],
