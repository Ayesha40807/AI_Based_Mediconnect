...
from .models import CustomUser, Patient, Visit, Reminder, Inquiry
...
class QuickPatientForm(ModelForm):
    ...
    class Meta:
        model = Patient
        fields = ["name", "age", "gender", "email","detail", "medicine_detail", "amount", "next_visit"]
...
class VisitForm(forms.ModelForm):
    class Meta:
        model = Visit
        fields = ["patient", "detail", "medicine_detail", "amount", "next_visit", "note", "medicines", "morning", "afternoon", "evening", "before_eating", "after_eating"]
        widgets = {
