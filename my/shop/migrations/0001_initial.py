    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, upload_to='media/patient_photos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visit_date', models.DateField(default=datetime.date.today, null=True)),
                ('morning', models.BooleanField(default=False)),
                ('afternoon', models.BooleanField(default=False)),
                ('evening', models.BooleanField(default=False)),
                ('before_eating', models.BooleanField(default=False)),
                ('after_eating', models.BooleanField(default=False)),
                ('medicines', models.ManyToManyField(related_name='visits', to='shop.medicine')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='visits', to='shop.patient')),
            ],
        ),
        migrations.CreateModel(
            name='PatientVisit',
